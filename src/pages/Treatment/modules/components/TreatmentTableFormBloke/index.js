...
function TreatmentTableFormBloke(props) {
    ...
    const setDataSourceTreatmentTable = useStore(
        (store) => store.setDataSourceTreatmentTable
    );
    ...
    const onFinish = (values) => {
        ...
        try {
            if (selectedRowKey) {
                ...
                values.id = id;
                values.key = id;
                values.treatmentDate = dayjs(values.treatmentDate).format(
                    "YYYY-MM-DD HH:mm"
                );
    ...
    const onFieldsChange = ([{ name, value }]) => {
        ...
        if (nameFormInput === "treatmentTypeName") {
        ...
        >
            ...
            <SimpleGrid columns={["1", "2"]} gap="1">
                <Box maxW="600px">
                    ...
                    <Form.Item label="Urgent Histology" name="histologyUrgent">
                        <Input.TextArea showCount maxLength={3000} rows={3} />
                    </Form.Item>

                    <Form.Item label="Histology Final" name="histologyFinal">
                        <Input.TextArea showCount maxLength={3000} rows={3} />
                    </Form.Item>
                        ...
                        <>
                            <Form.Item
                                ...
                                shouldUpdate={(prevValues, currentValues) =>
                                    prevValues.treatmentTypeName !==
                                    currentValues.treatmentTypeName
                                }
                            >
                                {({ getFieldValue }) =>
                            ...
                            <Form.Item
                                noStyle
                                shouldUpdate={(prevValues, currentValues) =>
                                    prevValues.SLNB !== currentValues.SLNB
                                }
                            >
                                {({ getFieldValue }) =>
                            ...
                            <Form.Item
                                noStyle
                                shouldUpdate={(prevValues, currentValues) =>
                                    prevValues.axillaDesection !==
                                    currentValues.axillaDesection
                                }
                            >
                                {({ getFieldValue }) =>
                ...
                <Box maxW="600px">
                    ...
                    <Form.Item label="Brest type" name="breastType">
                        <Select allowClear>
                            ...
                            <Select.Option value="Post mastectomy right">
                                Post mastectomy right
                            </Select.Option>
                            <Select.Option value="Post mastectomy left">
                                Post mastectomy left
                            </Select.Option>
                            <Select.Option value="Axilla right">
                                Axilla right
                            </Select.Option>
                            <Select.Option value="Axilla left">
                                Axilla left
                            </Select.Option>
                            <Select.Option value="Extra breast right">
                                Extra breast right
                            </Select.Option>
                            <Select.Option value="Extra breast left">
                                Extra breast left
                            </Select.Option>
                            <Select.Option value="Both extra breasts">
                                Both extra breasts
                            </Select.Option>
                        </Select>
                    </Form.Item>
                        ...
                        {({ getFieldValue }) =>
                            getFieldValue("treatmentTypeName") === "malign" ? (
                                <>
                                    ...
                                    >
                                        <Select allowClear>
                                            <Select.Option value="Organgoruyucu">
                                                Organoprotector
                                            </Select.Option>
                                            <Select.Option value="Masektamiya">
                                                Masectomy
                                            </Select.Option>
                                            <Select.Option value="SLNB">
                                                SLNB
                                            </Select.Option>
                                        </Select>
                                    </Form.Item>
                                    ...
                                    <Form.Item
                                        label="TB"
                                        name="treatmentSubSubType"
                                    >
                                        <Select allowClear>
                                            <Select.Option value="lumA">
                                                Lum A
                                            </Select.Option>
                                            <Select.Option value="lumB">
                                                Lum B
                                            </Select.Option>
                                            <Select.Option value="tripleN">
                                                Triple negative
                                            </Select.Option>
                                            <Select.Option value="hormoneP">
                                                Hormone positive Her positive
                                            </Select.Option>
                                            <Select.Option value="hormoneN">
                                                Hormone negative Her positive
                                            </Select.Option>
                                            <Select.Option value="prN">
                                                PR negative
                                            </Select.Option>
                                        </Select>
                                    </Form.Item>
                        ...
                        {({ getFieldValue }) =>
                            getFieldValue("treatmentTypeName") === "benign" ? (
                                <>
                                    ...
                                    >
                                        <Select allowClear>
                                            <Select.Option value="lumpektamiya">
                                                Lumpectamia
                                            </Select.Option>
                                            <Select.Option value="reduksiya">
                                                Reduction
                                            </Select.Option>
                                            <Select.Option value="mastopeksiya">
                                                Mastopexy
                                            </Select.Option>
                                            <Select.Option value="augumentasiya">
                                                Augmentation
                                            </Select.Option>
                                            <Select.Option value="Extra breast">
                                                Extra breast
                                            </Select.Option>
                                        </Select>
                                    </Form.Item>
                    ...
                    >
                        {({ getFieldValue }) =>
                            getFieldValue("treatmentTypeName") === "Nak" ||
                            getFieldValue("treatmentTypeName") === "RT" ? (
                                <Form.Item
                                    label="patamarfoz"
                                    name="treatmentSubType"
                                >
